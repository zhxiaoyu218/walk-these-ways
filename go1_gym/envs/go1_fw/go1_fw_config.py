...
def config_go1_fw(Cnfg: Union[Cfg, Meta]):
    _ = Cnfg.init_state
    ...
    _ = Cnfg.control
    _.control_type = 'P'
    _.stiffness = {'joint': 20., 'roller': 0.0}  # [N*m/rad]
    _.damping = {'joint': 0.5, 'roller': 0.0}  # [N*m*s/rad]
    ...
    _ = Cnfg.asset
    _.file = '{MINI_GYM_ROOT_DIR}/resources/robots/go1/urdf/go1_fw_contact.urdf'
    _.foot_name = "foot"
